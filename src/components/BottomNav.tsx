import { ChartLineUp, House, ListChecks, GearSix } from "@phosphor-icons/react";
...
export function BottomNav({ active, onChange }: BottomNavProps) {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-20 border-t border-border bg-surface-0/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl">
